...
export type GetEventsQueryVariables = AdminTypes.Exact<{
  cursor?: AdminTypes.InputMaybe<AdminTypes.Scalars['String']['input']>;
}>;


export type GetEventsQuery = { events?: AdminTypes.Maybe<{ nodes: Array<Pick<AdminTypes.BasicEvent, 'secondaryMessage' | 'additionalData' | 'additionalContent' | 'id' | 'action' | 'message' | 'attributeToApp' | 'attributeToUser' | 'createdAt' | 'criticalAlert'> | Pick<AdminTypes.CommentEvent, 'id' | 'action' | 'message' | 'attributeToApp' | 'attributeToUser' | 'createdAt' | 'criticalAlert'>>, pageInfo: Pick<AdminTypes.PageInfo, 'hasNextPage' | 'endCursor' | 'hasPreviousPage' | 'startCursor'> }> };
